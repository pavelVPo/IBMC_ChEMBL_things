...
# Около года назад (или даже раньше) я просил Вас оценить число различных
# записей по значениям IC50 в ChEMBL. Соответствующий слайд - в приложении.
# Буду признателен, если Вы обновите эту информацию на основе свежей
# информации в этой базе данных.
# Буду также признателен, если Вы, в дополнение к данной статистике,
# построите распределение по значениям IC50 для всех записей (включая
# многократные измерения для отдельных соединений). Подсчитайте, пожалуйста,
# для этого распределения среднее значение и медиану.
...
write_tsv(ic50_rslt, "C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/IC50_values.tsv")
write_tsv(pairs_pct |> arrange(category) |> rename(`Number of measurements` = category, `%` = pct), "C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/Number_of_measurements.tsv")
write_tsv(interval_stat |> rename(`Interval of pIC50` = interval, `Number of measurements` = n), "C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/IC50_nM_intervals.tsv")
write_tsv(ic50_avg, "C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/IC50_averaged.tsv")
#Export the results, plots
ggsave("C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/1_Number_of_measurements__ChEMBL_v36.png", plot = basic_summary_plot, width = 7, height = 5, units = "in", dpi = 300)
ggsave("C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/1_sqrt_Number_of_measurements__ChEMBL_v36.png", plot = sqrt_summary_plot, width = 7, height = 5, units = "in", dpi = 300)
ggsave("C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/2_Number_of_measurements_in_intervals__ChEMBL_v36.png", plot = base_ic50_nm_plot, width = 7, height = 5, units = "in", dpi = 300)
ggsave("C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/2_sqrt_Number_of_measurements_in_intervals__ChEMBL_v36.png", plot = sqrt_ic50_nm_plot, width = 7, height = 5, units = "in", dpi = 300)
ggsave("C:/Users/XPS/Documents/IBMC/2024/VVP/ppt_21-03-24/IC50_distribution/output_2025/3_Median_to_Mean__ChEMBL_v36.png", plot = medmean_plot, width = 7, height = 5, units = "in", dpi = 300)